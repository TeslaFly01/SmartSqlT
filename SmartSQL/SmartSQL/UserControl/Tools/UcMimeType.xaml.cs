...
namespace SmartSQL.UserControl
{
    ...
    /// </summary>
    public partial class UcMimeType : BaseUserControl
    {
        public UcMimeType()
        {
            InitializeComponent();
        ...
        {
            var mimeTypes = MimeTypeMap.BuildMappings();
        ...
        private void SearchText_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e)
        {
            ...
            var mimeTypes = MimeTypeMap.BuildMappings().Where(x => x.Key.Contains(searchText) || x.Value.Contains(searchText));
            TableGrid.ItemsSource = mimeTypes;
            if (!mimeTypes.Any())
            {
