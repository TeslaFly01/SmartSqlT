...
namespace SmartSQL.Views
{
    ...
    /// </summary>
    public partial class ConnectManageExtT : INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty DataListProperty = DependencyProperty.Register(
            "DataList", typeof(List<ConnectConfigs>), typeof(ConnectManageExtT), new PropertyMetadata(default(List<ConnectConfigs>)));
